          ...
          <div className="max-w-4xl mx-auto px-2 sm:px-4 lg:px-8">
            <div className="bg-white/20 backdrop-blur-md rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 border-4 sm:border-8 border-white/20 shadow-2xl">
              <div className="text-center mb-6 sm:mb-8">
                <h2
                  id="upcoming-events"
                  className="font-aeonik text-2xl sm:text-3xl lg:text-4xl font-medium mb-3 sm:mb-4 text-gray-900 px-2"
                >
                  <TextType
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-gray-900 mb-1">Holi Celebration</h3>
                        <p className="text-gray-600">Student Union · 6:00–8:00 PM</p>
                      </div>
                    </div>
                    <div className="flex flex-col space-y-2">
                      <button className="px-4 py-2 text-sm rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors">
                        Remind me
                      </button>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                {[
                  ...
                  <div
                    key={index}
                    className="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 cursor-pointer hover:shadow-xl transition-shadow"
                  >
                    <div className="text-center">
                      <div className="w-12 h-12 mx-auto mb-3 bg-gray-100 rounded-lg flex items-center justify-center">
                        <event.icon className="text-xl text-gray-600" />
                      </div>
                      <h4 className="font-semibold text-gray-900 mb-2 text-sm">{event.title}</h4>
                      <p className="text-sm text-gray-600 mb-3">{event.date}</p>
                      <button className="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors">
                        Remind me
                      </button>
                    </div>
                  </div>
              ...
              <div className="text-center">
                <Link
                  href="/events"
                  className="inline-flex items-center px-6 py-3 text-sm rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors"
                >
                  View all events
                </Link>
              </div>
